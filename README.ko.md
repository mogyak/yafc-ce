...
* [GIF 예시](/Docs/Gifs.ko.md): 여러 사용 사례 예시입니다. 단, GIF는 트래픽을 많이 사용합니다.
* [팁과 요령](/Docs/TipsAndTricks.ko.md) 및 [내장 한국어 팁](Yafc/Data/locale/ko/Tips.txt): 유용한 사용 팁입니다.
* [단축키](/Docs/Shortcuts.ko.md): 편의 단축키 모음입니다.
...
자세한 내용은 [소스 빌드 안내](/Docs/HowToBuild.ko.md)를 참고하세요.
...
- [명령줄](/Docs/CLI.ko.md)에서 프로젝트를 불러올 수 있습니다.
...
Pull Request를 만들고 싶다면 리뷰 과정이 원활하도록 [기여자 안내](Docs/CONTRIBUTING.ko.md)를 먼저 확인해 주세요.
